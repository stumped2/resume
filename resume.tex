...
\begin{resume}
    ...
    \begin{list2}
        ...
        \item Develop a chef workflow for development and integration testing (test kitchen, pull request centric)
        \item Create a chef manag ed environment to deploy and maintain OpenStack infrastructure using Stackforge Chef cookbooks
        ...
        \item Collaborate with IBM to deploy and document OpenStack on POWER hardware
    ...
    \item Learn and manage FreeBSD including ZFS, jails, and PF firewalling
